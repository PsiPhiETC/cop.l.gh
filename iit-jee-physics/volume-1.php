<?php
$PageTitle = "IIT JEE Physics Book: Table of Contents";
$PageDescription = "IIT JEE Physics Book: Table of Contents";
?>
...
<p>
<a href="iit-jee-physics-book-volume-1.html"><img class="align-right" width="150px" src="../images/iit-jee-physics-volume-1-2015.jpg" alt="IIT JEE Physics Volume 1"/></a>
The volume 1 of the book covers three parts: Mechanics, Waves, and Optics. The first part is on mechanics and it consists of 12 chapters. This part  starts with a chapter on "Units and Measurements" and ends up with a chapter on "Mechanical Properties of Matter". The second part of this volume contains wave phenomenon. There are three chapters in this part. Last chapter in this part is on light waves. Third part is on optics. This part contains for chapters covering various topics of optics. The list of chapters in these parts are given below.
</p>
