<?php
$PageTitle = "Contents in IIT JEE Physics Book";
$PageDescription = "Contents in IIT JEE Physics Book";
?>
...
<h1>IIT JEE Physics Book: Table of Contents</h1>
<h2>Contents in Volume 1</h2>
<p>
<a itemprop="url" href="iit-jee-physics-book-volume-1.html"><img itemprop="image" class="align-right" width="150px" src="../images/iit-jee-physics-volume-1-2015.jpg" alt="IIT JEE Physics Volume 1"/></a>
The volume 1 of <span itemprop="name"> IIT JEE Physics (1978-2015:38 Years) Topic-wise Complete Solutions</span>
covers three parts: Mechanics, Waves, and Optics. The first part is on mechanics and it consists of 12 chapters. This part  starts with a chapter on "Units and Measurements" and ends up with a chapter on "Mechanical Properties of Matter". The second part of this volume contains wave phenomenon. There are three chapters in this part. Last chapter in this part is on light waves. Third part is on optics. This part contains for chapters covering various topics of optics. The list of chapters in these parts are given below.
</p>
...
<ol>
	...
	<ol>
 		...
 		<li>Rest and Motion: Kinematics </li>
 		<li>Newton's Laws of Motion </li>
 		<li>Friction </li>
 		<li>Circular Motion </li>
 		<li>Work and Energy </li>
 		<li>Centre of Mass, Linear Momentum, Collision </li>
 		<li>Rotational Mechanics </li>
 		<li>Gravitation </li>
 		<li>Simple Harmonic Motion </li>
 		<li>Fluid Mechanics </li>
 		<li>Some Mechanical Properties of Matter </li>
 	</ol>	
	</li>
	<li>Waves
		<ol start="13">
			<li>Wave Motion and Waves on a String </li>
 			<li>Sound Waves </li>
 			<li>Light Waves </li>
		</ol>
 	</li>
	<li>Optics
		<ol start="16">
			<li>Geometrical Optics </li>
 			...
 			<li>Dispersion and Spectra </li>
 			<li>Photometry </li>
		</ol>
	</li>
</ol>
</div>
<h2>Contents in Volume 2</h1>
<p>
<a itemprop="url" href="iit-jee-physics-book-volume-2.html"><img itemprop="image" class="align-right" width="150px" src="../images/iit-jee-physics-volume-2-2015.jpg" alt="IIT JEE Physics Volume 1"/></a>
The volume 2 of <span itemprop="name"> IIT JEE Physics (1978-2015:38 Years) Topic-wise Complete Solutions</span> covers three parts: Thermodynamics, Electromagnetism, and Modern Physics. The part on thermodynamics consists of 6 chapters. This part  starts with a chapter on "Heat and Temperature" and ends up with a chapter on "Heat Transfer". The second part of this volume is on electromagnetism. There are eleven chapters in this part. The chapters starting from "Electric Field and Potential" to the chapter "Thermal and Chemical Effect of Electric Current" covers electrical phenomenon. Next six chapters are devoted to magnetism and electro magnetic induction. Third part is on modern physics. This part contains six chapters covering various topics related to modern physics. The list of chapters in these parts are given below.
</p>
<div  class="table_of_contents"> 
<ol start="4">
	<li>Thermodynamics
  ...
  <li>Gauss's Law</li>
  <li>Capacitors</li>
  <li>Electric Current in Conductors</li>
  <li>Thermal and Chemical Effects of Electric Current</li>
  ...
  <li>Electromagnetic Waves</li>
	...
	<li>Modern Physics
	<ol start="37">
  <li>Electric Current through Gases</li>
  <li>Photoelectric Effect and Wave-Particle Duality</li>
  <li>Bohr's Model and Physics of the Atom</li>
  <li>X-rays</li>
  <li>Semiconductors and Semiconductor Devices</li>
  <li>The Nucleus</li>
</ol>
	</li>	
</ol>
